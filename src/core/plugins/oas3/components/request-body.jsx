...
class RequestBodyJsonSchemaForm extends React.Component {
  onChange = (value) => {
  ...
  render() {
    ...
    const JsonSchemaForm = props.getComponent("JsonSchemaForm")
    return <JsonSchemaForm {...props} onChange={this.onChange} />
  }
}

RequestBodyJsonSchemaForm.propTypes = {
  propertyKey: PropTypes.string.isRequired,
  onChange: PropTypes.func.isRequired,
  getComponent: PropTypes.func.isRequired,
}

class RequestBodyParameterIncludeEmpty extends React.Component {
  onChange = (value) => {
    this.props.onChange(this.props.propertyKey, value)
  }
  render() {
    const { ...props } = this.props
    delete props.propertyKey
    delete props.onChange
    const ParameterIncludeEmpty = props.getComponent("ParameterIncludeEmpty")
    return <RequestBodyParameterIncludeEmptyInner ParameterIncludeEmpty={ParameterIncludeEmpty} {...props} onChange={this.onChange} />
  }
}

const RequestBodyParameterIncludeEmptyInner = ({ ParameterIncludeEmpty, ...props }) => <ParameterIncludeEmpty {...props} />
RequestBodyParameterIncludeEmptyInner.propTypes = {
  ParameterIncludeEmpty: PropTypes.func.isRequired,
}

RequestBodyParameterIncludeEmpty.propTypes = {
  propertyKey: PropTypes.string.isRequired,
  onChange: PropTypes.func.isRequired,
  getComponent: PropTypes.func.isRequired,
}
...
class RequestBody extends React.Component {
  ...
  handleExamplesSelect = (key) => {
    this.props.updateActiveExamplesKey(key)
  }
  ...
  onChangeIncludeEmpty = (key, value) => {
    this.props.onChangeIncludeEmpty(key, value)
  }

  setIsIncludedOptions = (key) => {
    const { requestBodyInclusionSetting } = this.props
    let options = {
      key,
          ...
          <tbody>
            {
              Map.isMap(bodyProperties) && bodyProperties.entrySeq().map(([key, schema]) => {
                ...
                const jsonSchemaForm = <RequestBodyJsonSchemaForm
                  fn={fn}
                ...
                <td className="parameters-col_name">
                  ...
                  <div className="parameter__type parameter__deprecated">
                ...
                <td className="parameters-col_description">
                  ...
                  {isExecute ? <div>
                    ...
                    {required ? null : (
                      <RequestBodyParameterIncludeEmpty
                        propertyKey={key}
                        getComponent={getComponent}
                        onChange={this.onChangeIncludeEmpty}
                        isIncluded={included}
                        isIncludedOptions={this.setIsIncludedOptions(key)}
      ...
      }
      {
        sampleForMediaType ? (
          <ExamplesSelectValueRetainer
              ...
              onSelect={this.handleExamplesSelect}
