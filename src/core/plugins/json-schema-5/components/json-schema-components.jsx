          ...
          (value.map((item, i) => {
            ...
            return (
              <JsonSchemaArrayItem
                ...
                isArrayItemFile={isArrayItemFile}
                isArrayItemText={isArrayItemText}
                disabled={disabled}
                getComponent={getComponent}
                ArrayItemsComponent={ArrayItemsComponent}
                fn={fn}
                needsRemoveError={needsRemoveError}
                schemaItemsSchema={schemaItemsSchema}
                {...this.props}
              />
            )
          })
...
class JsonSchemaArrayItem extends Component {
  onItemChange = (val) => {
    this.props.onItemChange(val, this.props.index)
  }
  removeItem = () => {
  ...
  render() {
    const {
      isArrayItemFile, isArrayItemText, item, disabled, itemErrors,
      getComponent, ArrayItemsComponent, fn, needsRemoveError, schemaItemsSchema
    } = this.props
    const Button = getComponent("Button")

    return (
      <div className="json-schema-form-item">
        {
          isArrayItemFile ?
...
JsonSchemaArrayItem.propTypes = {
  index: PropTypes.number.isRequired,
  onItemChange: PropTypes.func.isRequired,
  removeItem: PropTypes.func.isRequired,
  isArrayItemFile: PropTypes.bool,
  isArrayItemText: PropTypes.bool,
  item: PropTypes.any,
  disabled: PropTypes.bool,
  itemErrors: PropTypes.object,
  getComponent: PropTypes.func.isRequired,
  ArrayItemsComponent: PropTypes.func,
  fn: PropTypes.object.isRequired,
  needsRemoveError: PropTypes.array,
  schemaItemsSchema: PropTypes.object,
}
