      ...
      { !error ? null :
        <div>
          ...
          <div className="error-line">
            { errorLine && jumpToLine ? <JumpToLineLink jumpToLine={jumpToLine} line={errorLine} /> : null }
          </div>
        </div>
      }
    </div>
    ...
    <div className="error-wrapper">
      { !error ? null :
        <div>
          ...
          <div className="error-line">
            { jumpToLine ? (
              <JumpToLineLink jumpToLine={jumpToLine} line={error.get("line")} />
            ) : null }
          </div>
        </div>
      }
...
class JumpToLineLink extends React.Component {
  handleClick = () => {
    this.props.jumpToLine(this.props.line)
  }
  render() {
    return <a onClick={this.handleClick}>Jump to line {this.props.line}</a>
  }
}

JumpToLineLink.propTypes = {
