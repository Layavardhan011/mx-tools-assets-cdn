...
export default class Parameters extends Component {
  ...
  handleToggleTabParameters = () => this.toggleTab("parameters")
  handleToggleTabCallbacks = () => this.toggleTab("callbacks")
  handleResetClick = () => this.props.onResetClick(this.props.pathMethod)

  handleOnChangeMediaType = (value) => {
    this.onChangeMediaType({ value, pathMethod: this.props.pathMethod })
  }

  handleSetRetainRequestBodyValueFlag = (f) => {
    this.props.oas3Actions.setRetainRequestBodyValueFlag({ value: f, pathMethod: this.props.pathMethod })
  }

  handleUpdateActiveExamplesKey = (key) => {
  ...
  handleRequestBodyOnChange = (value, path) => {
    const { oas3Actions, oas3Selectors, pathMethod } = this.props
    if (path) {
  ...
  handleRequestBodyOnChangeIncludeEmpty = (name, value) => {
    this.props.oas3Actions.setRequestBodyInclusion({
      pathMethod: this.props.pathMethod,
      value,
      name,
    })
        ...
        <div className="opblock-section-header">
          {isOAS3 ? (
            <div className="tab-header">
              <div onClick={this.handleToggleTabParameters}
                   className={`tab-item ${this.state.parametersVisible && "active"}`}>
                <h4 className="opblock-title"><span>Parameters</span></h4>
              </div>
              {operation.get("callbacks") ?
                (
                  <div onClick={this.handleToggleTabCallbacks}
        ...
        </div> : null}
        {
          ...
          <div className="opblock-section opblock-section-request-body">
            <div className="opblock-section-header">
              ...
              <label id={controlId}>
                <ContentType
                  ...
                  onChange={this.handleOnChangeMediaType}
            ...
            <div className="opblock-description-wrapper">
              <RequestBody
                setRetainRequestBodyValueFlag={this.handleSetRetainRequestBodyValueFlag}
                ...
                updateActiveExamplesKey={this.handleUpdateActiveExamplesKey}
                onChange={this.handleRequestBodyOnChange}
                onChangeIncludeEmpty={this.handleRequestBodyOnChangeIncludeEmpty}
